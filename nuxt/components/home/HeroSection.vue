...
<template>
  <UiContainer class="py-20 text-center lg:py-32">
    <h1 class="mx-auto max-w-3xl text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
      ...
      <span class="relative whitespace-nowrap text-primary-600">
        ...
        <span class="relative">con facilidad</span>
      </span>
    </h1>

    <p class="mx-auto mt-8 max-w-2xl text-lg tracking-tight text-gray-700">
      Mi Asistente te ayudará a controlar todos los aspectos de tu estética en un solo lugar. Agenda, ventas,
    ...
    <div class="mt-10 flex flex-col justify-center gap-4 xs:flex-row xs:gap-6">
      ...
      <a href="#precios" class="btn btn-outlined">Ver precios</a>
    </div>
  </UiContainer>
</template>
